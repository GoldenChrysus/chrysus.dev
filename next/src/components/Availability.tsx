...
import { IconCircleFilled, IconTriangleFilled } from '@tabler/icons-react';
...
export function Availability() {
  ...
  const items = useMemo(() => ([
    ...
    },
    {
      ...
      info: t`I am currently accepting short- and medium-term freelance work.`,
      icon: <IconCircleFilled color="var(--mantine-color-green-filled)" />,
      direction: "right"
    }
  ]), [t]);
